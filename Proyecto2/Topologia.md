...
| SW-ADM-DIST | Gi0/1   | SW-ADM-ACC   | Gi0/1  | EtherChannel 1 enlace A            |
| SW-ADM-DIST | Gi0/2   | SW-ADM-ACC   | Gi0/2  | EtherChannel 1 enlace B            |
| SW-ADM-DIST | Gi0/3   | SRV-DNS-HTTP | Fa0    | Red de servidores                  |
...
| SW-ATC-DIST | Gi0/1   | SW-ATC-ACC   | Gi0/1  | EtherChannel 2 enlace A            |
| SW-ATC-DIST | Gi0/2   | SW-ATC-ACC   | Gi0/2  | EtherChannel 2 enlace B            |
| SW-ATC-ACC  | Fa0/1   | PC-ATC-1     | Fa0    | Host                               |
| SW-ATC-ACC  | Fa0/2   | PC-ATC-2     | Fa0    | Host                               |
| SW-ATC-ACC  | Fa0/2   | PC-ATC-3     | Fa0    | Host                               |
...
| SW-VENTAS-DIST | Gi0/1   | SW-VENTAS-ACC  | Gi0/1  | EtherChannel 1 enlace A            |
| SW-VENTAS-DIST | Gi0/2   | SW-VENTAS-ACC  | Gi0/2  | EtherChannel 1 enlace B            |
| SW-FACT-DIST   | Gi0/1   | SW-FACT-ACC    | Gi0/1  | EtherChannel 2 enlace A            |
| SW-FACT-DIST   | Gi0/2   | SW-FACT-ACC    | Gi0/2  | EtherChannel 2 enlace B            |
...
| SW-FACT-ACC    | Fa0/2   | PC-FACT-3      | Fa0    | Host                               |
...
| Origen      | Puerto    | Destino     | Puerto   | Nota                               |
| ----------- | --------- | ----------- | -------- | ---------------------------------- |
| ICP3        | Gi1/1/3   | R1-CF       | Gi0/0    | Salida de ISP3 hacia interconexion |
...
| SW-SOP-DIST | Gi0/1     | SW-SOP-ACC  | Gi0/1    | EtherChannel 1 enlace A            |
| SW-SOP-DIST | Gi0/2     | SW-SOP-ACC  | Gi0/2    | EtherChannel 1 enlace B            |
...
| SW-SEG-DIST | Gi0/1     | SW-SEG-ACC  | Gi0/1    | EtherChannel 2 enlace A            |
| SW-SEG-DIST | Gi0/2     | SW-SEG-ACC  | Gi0/2    | EtherChannel 2 enlace B            |
| SW-SEG-ACC  | Fa0/1     | PC-SEG-1    | Fa0      | Host                               |
| SW-SEG-ACC  | Fa0/2     | PC-SEG-2    | Fa0      | Host                               |
| SW-SEG-ACC  | Fa0/2     | PC-SEG-3    | Fa0      | Host                               |
